...
source-environment comparison.  It can also
...
Lean
also proves that, in the nonpositive environment branch, the nonzero coordinate
target-bound formulation is equivalent to this environment bound against the
