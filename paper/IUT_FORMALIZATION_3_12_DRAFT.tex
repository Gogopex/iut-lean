...
\Theta_{\mathrm{signed}}\) route through the nonzero-bound endpoint.  More
...
factored route.  For nonzero labels, Lean
...
nonzero-label branch also feeds the final \(q\)-to-\(\Theta\) theorem.  On the nonzero-label part, the formal
