...
that average.  More generally, Lean decomposes the all-label Gaussian bound
...
the nonpositive/nonnegative branch hypotheses.  The nonzero environment route
...
source-environment comparison, and that the all-label predicate is equivalent
...
directly, and it can alternatively derive that package from a source all-label
Gaussian bound under source nonpositivity.  The source all-label predicate is
itself equivalent, under source nonpositivity, to the conjunction of
...
consume the decomposed zero/nonzero input directly.  For nonzero labels, Lean
...
corresponding direct endpoint is exposed with this decomposed input.
The
