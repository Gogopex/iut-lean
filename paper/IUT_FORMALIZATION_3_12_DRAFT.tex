...
\item the Step (xii) shadow: local Frobenioid \(p_v^N\)-ambiguity changes
  ...
  shifted value in the collapsed region.  Hence, if the collapsed region also
  contains a nonzero local shift, Lean proves that the quotient identifies it
  with the fixed q/determinant boundary while the underlying log-volumes remain
  unequal; this broad-collapse diagnostic is now packaged as a
