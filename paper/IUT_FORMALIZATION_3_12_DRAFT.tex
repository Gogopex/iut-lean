...
same average.  More generally, Lean decomposes the all-label Gaussian bound
...
nonzero-label bound under the environment comparison.  On the nonzero-label part, the formal
