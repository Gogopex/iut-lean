...
\item the Step (xi-d)--(xi-f) shadow: rank \(>1\) determinant normalization and
  the upper-ray membership \(q\in R_{\le\Theta}\Rightarrow q\le\Theta\);
...
action, base-valuation product, coric-transfer, determinant-normalization, and
upper-ray shadows.
...
\item the genuine holomorphic hull and determinant operations of Step (xi),
  beyond the present finite determinant/upper-ray shadows;
