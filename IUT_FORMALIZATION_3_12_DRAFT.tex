...
\item the degree-level Gaussian evaluation
  ...
  also proves that translation by \(1\) does not descend to a well-defined map
  on \(|F_\ell|\), since the equal absolute labels of \(1\) and \(-1\) would
  have to map simultaneously to the nonzero label of \(2\) and to \(0\);
